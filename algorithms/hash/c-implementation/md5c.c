...
processing another message block, andupdating the context.
*/
...
unsigned int len;
{
	...
	for (i = 0, j = 0; j < len; i++, j+=4 ) {
		...
		output[j + 1] = (unsigned char)((input[i] >> 24) & 0xff);
	}
}
 ...
 */
static void MD5_memcpy (ouput, input, len)
POINTER ouput;
POINTER input;
unsigned int len;
{
...
/*
 * Note: Replce "for loop" with standard memset if possible.
 */
